<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="{{ route('doctor_home') }}">doctor Panel</a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="{{ route('doctor_home') }}"></a>
        </div>

        <ul class="sidebar-menu">

            <li class="{{ Request::is('doctor/home') ? 'active' : '' }}"><a class="nav-link"
                    href="{{ route('doctor_home') }}"><i class="fas fa-hand-point-right"></i>
