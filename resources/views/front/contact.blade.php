    ...
    <div class="page-top">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2
                        style="text-align: center; padding-top: 63px; padding-bottom: 67px; background-color: lemonchiffon; color: green;">
                        {{ $contact_data->contact_heading }}</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="page-content">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="map">
                        {!! nl2br($contact_data->contact_map) !!}
                    </div>
                </div>
            </div>
        </div>
