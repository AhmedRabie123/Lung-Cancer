...
@endphp
        ...
        <div class="carousel-indicators active">
            <button type="button" data-bs-target="{{ $i }}" data-bs-slide-to="{{ $i }}"  aria-current="true"
            ...
            <div class="carousel-inner">
                <ol class="carousel-indicators">
                    <li data-bs-target="#myCarouse{{ $i }}" data-bs-slide-to="{{ $i }}"></li>
                    {{-- <li data-bs-target="#myCarousel" data-bs-slide-to="1"></li>
                    <li data-bs-target="#myCarousel" data-bs-slide-to="2"></li> --}}
                </ol>

                <div class="carousel-item active">
                    <img src="{{ asset('uploads/' . $item->photo) }}" class="d-block w-100 img1-carousel"
                        alt="...">
